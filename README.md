## rtabmap (noetic) - 0.21.13-1

The packages in the `rtabmap` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic rtabmap` on `Sun, 27 Apr 2025 22:31:50 -0000`
...
## rtabmap (noetic) - 0.21.10-1

The packages in the `rtabmap` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic rtabmap` on `Thu, 13 Feb 2025 03:53:10 -0000`
...
- old version: `0.21.9-1`
- new version: `0.21.10-1`
...
## rtabmap (noetic) - 0.21.9-1

The packages in the `rtabmap` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic rtabmap` on `Sun, 01 Dec 2024 18:31:34 -0000`
...
## rtabmap (noetic) - 0.21.6-1

The packages in the `rtabmap` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic rtabmap` on `Tue, 23 Jul 2024 04:27:53 -0000`
...
- upstream repository: https://github.com/introlab/rtabmap.git
- release repository: https://github.com/introlab/rtabmap-release.git
- rosdistro version: `0.21.5-1`
- old version: `0.21.5-1`
- new version: `0.21.6-1`
...
## rtabmap (noetic) - 0.21.5-1

The packages in the `rtabmap` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic rtabmap` on `Mon, 01 Jul 2024 02:34:45 -0000`
...
## rtabmap (noetic) - 0.21.4-1

The packages in the `rtabmap` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic rtabmap` on `Wed, 21 Feb 2024 03:13:29 -0000`
...
- upstream repository: https://github.com/introlab/rtabmap.git
- release repository: https://github.com/introlab/rtabmap-release.git
- rosdistro version: `0.21.3-1`
- old version: `0.21.3-1`
- new version: `0.21.4-1`
...
## rtabmap (noetic) - 0.21.3-1

The packages in the `rtabmap` repository were released into the `noetic` distro by running `/usr/bin/bloom-release rtabmap --ros-distro noetic` on `Sat, 06 Jan 2024 21:50:45 -0000`
...
## rtabmap (noetic) - 0.21.1-1

The packages in the `rtabmap` repository were released into the `noetic` distro by running `/usr/bin/bloom-release rtabmap --rosdistro noetic` on `Sun, 09 Apr 2023 22:51:32 -0000`
...
## rtabmap (foxy) - 0.21.1-1

The packages in the `rtabmap` repository were released into the `foxy` distro by running `/usr/bin/bloom-release rtabmap --rosdistro foxy` on `Sun, 09 Apr 2023 22:48:04 -0000`
...
## rtabmap (foxy) - 0.20.23-1

The packages in the `rtabmap` repository were released into the `foxy` distro by running `/usr/bin/bloom-release rtabmap --rosdistro foxy` on `Sun, 22 Jan 2023 22:24:22 -0000`
...
## rtabmap (noetic) - 0.20.23-1

The packages in the `rtabmap` repository were released into the `noetic` distro by running `/usr/bin/bloom-release rtabmap --rosdistro noetic` on `Sun, 22 Jan 2023 22:22:50 -0000`
...
## rtabmap (melodic) - 0.20.23-1

The packages in the `rtabmap` repository were released into the `melodic` distro by running `/usr/bin/bloom-release rtabmap --rosdistro melodic` on `Sun, 22 Jan 2023 22:20:08 -0000`
...
## rtabmap (foxy) - 0.20.22-1

The packages in the `rtabmap` repository were released into the `foxy` distro by running `/usr/bin/bloom-release rtabmap --rosdistro foxy -y` on `Sun, 11 Dec 2022 21:42:57 -0000`
...
## rtabmap (noetic) - 0.20.22-1

The packages in the `rtabmap` repository were released into the `noetic` distro by running `/usr/bin/bloom-release rtabmap --rosdistro noetic` on `Sun, 11 Dec 2022 21:40:40 -0000`
...
## rtabmap (melodic) - 0.20.22-1

The packages in the `rtabmap` repository were released into the `melodic` distro by running `/usr/bin/bloom-release rtabmap --rosdistro melodic` on `Sun, 11 Dec 2022 21:37:38 -0000`
...
- upstream repository: https://github.com/introlab/rtabmap.git
- release repository: https://github.com/introlab/rtabmap-release.git
- rosdistro version: `0.20.21-4`
- old version: `0.20.21-4`
- new version: `0.20.22-1`
...
## rtabmap (galactic) - 0.20.21-1

The packages in the `rtabmap` repository were released into the `galactic` distro by running `/usr/bin/bloom-release rtabmap --rosdistro galactic` on `Sun, 02 Oct 2022 02:01:32 -0000`
...
## rtabmap (foxy) - 0.20.21-1

The packages in the `rtabmap` repository were released into the `foxy` distro by running `/usr/bin/bloom-release rtabmap --rosdistro foxy` on `Sun, 02 Oct 2022 01:59:20 -0000`
...
## rtabmap (noetic) - 0.20.21-1

The packages in the `rtabmap` repository were released into the `noetic` distro by running `/usr/bin/bloom-release rtabmap --rosdistro noetic` on `Sun, 02 Oct 2022 01:55:45 -0000`
...
## rtabmap (melodic) - 0.20.21-4

The packages in the `rtabmap` repository were released into the `melodic` distro by running `/usr/bin/bloom-release rtabmap --rosdistro melodic` on `Sun, 02 Oct 2022 01:51:22 -0000`
...
- upstream repository: https://github.com/introlab/rtabmap.git
- release repository: https://github.com/introlab/rtabmap-release.git
- rosdistro version: `0.20.18-4`
- old version: `0.20.21-3`
- new version: `0.20.21-4`
...
## rtabmap (melodic) - 0.20.21-3

The packages in the `rtabmap` repository were released into the `melodic` distro by running `/usr/bin/bloom-release rtabmap --rosdistro melodic` on `Sun, 02 Oct 2022 01:49:29 -0000`
...
- release repository: https://github.com/introlab/rtabmap-release.git
- rosdistro version: `0.20.18-4`
- old version: `0.20.21-2`
- new version: `0.20.21-3`
...
## rtabmap (melodic) - 0.20.21-2

The packages in the `rtabmap` repository were released into the `melodic` distro by running `/usr/bin/bloom-release rtabmap --rosdistro melodic` on `Sun, 02 Oct 2022 01:47:13 -0000`
...
## rtabmap (melodic) - 0.20.21-1

The packages in the `rtabmap` repository were released into the `melodic` distro by running `/usr/bin/bloom-release rtabmap --rosdistro melodic` on `Sun, 02 Oct 2022 01:41:40 -0000`
...
The packages in the `rtabmap` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --track melodic --rosdistro melodic rtabmap` on `Thu, 03 Mar 2022 20:06:59 -0000`
